...
from ctypes_mosquitto.constants import ConnackCode, ProtocolVersion, MQTT5PropertyID
from ctypes_mosquitto.client import PropertyFactory, find_prop
...
def test_v5_props(client):
    ...
    def _on_message(client, userdata, msg, props):
        userdata.prop = find_prop(props, MQTT5PropertyID.MESSAGE_EXPIRY_INTERVAL)
        is_recv.set()
